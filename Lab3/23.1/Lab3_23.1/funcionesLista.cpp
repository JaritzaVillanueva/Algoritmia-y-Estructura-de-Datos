...
struct Nodo * crearNodo(int nivelImpac, char cat, struct Nodo * siguiente){

    struct Nodo * nuevoNodo = new struct Nodo;
    nuevoNodo->categoria = cat;
    nuevoNodo->nivelImpacto = nivelImpac;
...
void insertarAlFinal(struct Lista & lista, int nivelImpac, char cat){
    struct Nodo * nuevoNodo = crearNodo(nivelImpac, cat, nullptr);
