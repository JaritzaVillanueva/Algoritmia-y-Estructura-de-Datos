...
struct NodoArbol * crearNuevoNodoArbol(struct NodoArbol *, const char*, int, 
                                                          struct NodoArbol *);
void plantarArbolBinario(struct ArbolBinario &, struct NodoArbol *, const char*, int,
                                                       struct NodoArbol * );
void plantarArbolBinario(struct ArbolBinario &, struct ArbolBinario &, const char*, int,
                                                struct ArbolBinario &);
...
void destruirRecursivo(struct NodoArbol *, struct NodoArbol * );
